...
import RouteBookingSheet from './src/components/RouteBookingSheet';
...
// ΓöÇΓöÇΓöÇ Location Picker Screen (moveable center-pin map) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function HomeScreen({ onRideBooked, onNavigateProfile, onNavigateLanguage, activePasses = [], onPassPurchased }: { onRideBooked: (ride: any) => void; onNavigateProfile: () => void; onNavigateLanguage: () => void; activePasses?: any[]; onPassPurchased?: () => void; }) {
  ...
  // ΓöÇΓöÇ Location / booking state ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Picker state ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  type PickerMode = null | 'pickup' | 'drop';
  const [pickerMode, setPickerMode] = useState<PickerMode>(null);

  // ΓöÇΓöÇ Tab bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Profile fields ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Nearby drivers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  const handleTopup = async () => {
    ...
    try {
      ...
      Alert.alert('Success', `Γé╣${walletAmount} added to wallet!`);
  ...
  const getVehicleEmoji = (type: string) => ({ bike: '≡ƒÅì∩╕Å', auto: '≡ƒ¢║', mini: '≡ƒÜù', sedan: '≡ƒÜÿ', suv: '≡ƒÜÖ' }[type] || '≡ƒÜù');
  ...
  // ΓöÇΓöÇ If picker is open ΓÇö show full-screen picker ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  if (pickerMode) {
  ...
  // ΓöÇΓöÇ Main home screen ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  return (
    <View style={styles.homeContainer}>
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ HOME TAB ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {activeTab === 'home' && (
        <View style={{ flex: 1 }}>
          {(!dropAddr && (!estimates || estimates.length === 0) && pickerMode === null && !bookingRide && !showMap && !showRouteBookingSheet) ? (
            <DashboardUI 
              user={user}
              activePasses={activePasses}
              ...
              onBookRide={() => setShowRouteBookingSheet(true)}
              onSearchClick={() => setPickerMode('drop')}
...
{pickupCoords && pickupCoords.length === 2 && (
            ...
            <TouchableOpacity style={styles.homePickupStrip} activeOpacity={0.85} onPress={() => setPickerMode('pickup')}>
              ...
              <Text style={styles.homePickupText} numberOfLines={1}>
                {pickupAddr || 'Detecting your locationΓÇª'}
              </Text>
          ...
          <View style={styles.homeBottomCard}>
            ...
            {loadingEstimates && (
              <View style={styles.estimateLoaderWrapper}>
                ...
                <Text style={styles.loaderLabel}>Computing route & surge faresΓÇª</Text>
              </View>
            )}
                        ...
                        <View style={{ alignItems: 'flex-end' }}>
                          ...
                          {(est.fareDetails.passDiscount > 0 || est.fareDetails.discount > 0) && (
                            <Text style={{ fontSize: 12, fontWeight: '500', color: '#7C848D', textDecorationLine: 'line-through' }}>
                              Γé╣{est.fareDetails.originalFare}
                            </Text>
                          )}
                        </View>
                      )}
                ...
                <View style={{ marginTop: 24, paddingBottom: Platform.OS === 'ios' ? 20 : 0 }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                      <Text style={{ fontSize: 16, color: '#262D36', fontWeight: '500' }}>Γé╣ Cash</Text>
                    ...
                    >
                      {bookingRide ? <ActivityIndicator color="#FCFCFC" /> : (
                        <Text style={{ color: '#FCFCFC', fontSize: 16, fontWeight: '600' }}>Confirm Ride Γé╣{offeredFare}</Text>
                      )}
                    </TouchableOpacity>
                  </View>
                </View>
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ PASS TAB (REDESIGNED) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {activeTab === 'wallet' && (
        <MyPassScreen
          user={user}
          activePasses={activePasses}
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.bgPrimary }}>
          <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1, paddingHorizontal: 16, paddingTop: 40 }} contentContainerStyle={{ paddingBottom: 120 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                ...
                <View style={{ justifyContent: 'center', flex: 1 }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 2, marginTop: 4 }}>
                    <Text style={{ color: '#FED101', fontSize: 14 }}>Γÿà</Text>
                    <Text style={{ color: '#FED101', fontSize: 14 }}>Γÿà</Text>
                    <Text style={{ color: '#FED101', fontSize: 14 }}>Γÿà</Text>
                    <Text style={{ color: '#FED101', fontSize: 14 }}>Γÿà</Text>
                    <Text style={{ color: '#8DABCE', fontSize: 14 }}>Γÿà</Text>
            ...
            <TouchableOpacity style={{ backgroundColor: colors.bgSecondary, borderRadius: 16, padding: 20, marginBottom: 20, flexDirection: 'column', gap: 4 }}>
              <Text style={{ color: colors.textPrimary, fontSize: 14, fontWeight: '400' }}>Upto Γé╣4,500 referral bonus</Text>
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ TRIPS TAB ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {activeTab === 'trips' && (
        <View style={styles.custTabPage}>
          ...
          {loadingRides ? (
            <View style={styles.ridesLoader}>
              ...
              <Text style={styles.ridesLoaderText}>Loading tripsΓÇª</Text>
            </View>
          ) : (
            <FlatList
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ WALLET TAB ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {activeTab === 'services' && (
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ BOTTOM TAB BAR (REDESIGNED) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ MANAGE PASS MODAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ WALLET MODAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {showRouteBookingSheet && (
        <View style={[StyleSheet.absoluteFillObject, { zIndex: 1000 }]}>
          <RouteBookingSheet 
            onCancel={() => setShowRouteBookingSheet(false)}
            onRouteSelected={(route: any, color: string) => {
              setSelectedMetroRoute({ route, color });
              setShowRouteBookingSheet(false);
              setShowMap(true);
              
              // Try to fit the route on the map
              if (route.polyline && mapRef.current) {
...
function TrackingScreen({ ride, onClose }: { ride: any; onClose: () => void }) {
  ...
  // ΓöÇΓöÇ Customer-side Navigation State ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Socket listeners ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
  ...
  // ΓöÇΓöÇ Customer live navigation (fires when GPS updates & trip is active) ΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
    ...
    if (steps.length > 0) {
      ...
      // Fallback: nearest polyline point ΓåÆ remaining distance
  ...
  // ΓöÇΓöÇ Nav HUD data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
{/* Customer live position (only when navigating) */}
      ...
      {/* ΓöÇΓöÇ CUSTOMER NAVIGATION HUD (in_progress only) ΓöÇΓöÇ */}
      {rideStatus === 'in_progress' && (
        <View style={styles.custNavHudWrapper} pointerEvents="none">
          ...
          <View style={styles.custNavEtaStrip}>
            ...
            <View style={styles.navEtaRow}>
              <Text style={styles.custNavEtaText}>≡ƒòÆ {remainingETA} min</Text>
              <Text style={styles.custNavEtaText}>≡ƒôì {formatDistance(remainingDist)}</Text>
              <Text style={styles.custNavEtaText}>Γåô {ride.drop?.address?.split(',')[0]}</Text>
            </View>
          </View>
        </View>
      )}

      {/* ΓöÇΓöÇ Pre-trip sheet ΓÇö rendered as absolute overlay directly on screen ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ BOTTOM SHEET (searching / in_progress / completed only) ΓöÇΓöÇ */}
      ...
      <View style={rideStatus === 'in_progress' ? styles.custNavBottomSheet : styles.custNavBottomSheet}>
        ...
        {/* ΓöÇΓöÇ In-progress compact bottom row ΓöÇΓöÇ */}
        {rideStatus === 'in_progress' && (
        ...
        {/* ΓöÇΓöÇ Completed / Rating ΓöÇΓöÇ */}
...
function DriverHomeScreen({ onRideAccepted, onNavigateProfile, onNavigateHistory, onNavigateWallet, onNavigateAchievements }: { onRideAccepted: (ride: any) => void; onNavigateProfile: () => void; onNavigateHistory: () => void; onNavigateWallet: () => void; onNavigateAchievements: () => void; }) {
  ...
  return (
    <View style={styles.container}>
          ...
          <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: 16, paddingTop: 30, paddingBottom: 100 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              <View style={{ flexDirection: 'column', gap: 8 }}>
                ...
                <Text style={{ fontFamily: 'sans-serif', fontSize: 28, fontWeight: '500', color: colors.textPrimary }}>Γé╣ {getTodayEarnings()}</Text>
              </View>
              <TouchableOpacity 
              ...
              >
                ...
                <Text style={{ fontSize: 16, fontWeight: '600', color: earningsData?.walletBalance < 0 ? '#DC2626' : colors.textPrimary }}>
                  Γé╣ {earningsData?.walletBalance !== undefined ? earningsData.walletBalance.toFixed(2) : '0.00'}
                </Text>
              </TouchableOpacity>
            </View>
                  ...
                  {[{amt: 250, orders: 10}, {amt: 350, orders: 14}, {amt: 450, orders: 20}].map((target, idx) => {
                    ...
                    return (
                      <View key={idx} style={{ alignItems: 'center', gap: 16 }}>
                        <Text style={{ fontFamily: 'sans-serif', fontSize: 14, color: isAchieved ? '#39B45C' : '#0053B3', letterSpacing: 0.5, fontWeight: isAchieved ? 'bold' : 'normal' }}>Γé╣ {target.amt}</Text>
            ...
            <View style={{ backgroundColor: '#1A1919', borderRadius: 12, height: 162, padding: 16, overflow: 'hidden', position: 'relative', marginBottom: 16 }}>
              ...
              <Text style={{ color: '#038CAB', fontSize: 12, letterSpacing: 0.5, marginBottom: 12 }}>Γé╣ 141/day</Text>
            ...
            <View style={{ backgroundColor: '#E0F2FE', borderRadius: 12, padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, borderWidth: 1, borderColor: '#BAE6FD' }}>
              <View style={{ flex: 1, paddingRight: 12 }}>
                ...
                <Text style={{ fontSize: 12, color: '#0284C7', marginBottom: 10 }}>Protect yourself and your vehicle starting at Γé╣199/month.</Text>
      ...
      {/* ΓöÇΓöÇ New Ride Request Overlay ΓöÇΓöÇ */}
      {incomingRequest && (
            ...
            <View style={styles.incomingStatsRowLight}>
              ...
              <View style={styles.incomingStatChipLight}>
                ...
                <Text style={styles.incomingStatValLight}>
                  {'Γé╣'}{incomingRequest.estimatedEarnings}
                </Text>
              </View>
            </View>
...
// ΓöÇΓöÇΓöÇ Navigation Helper Functions ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
/** Bearing in degrees (0ΓÇô360) from point A to point B */
...
function getManeuverIcon(type: string, modifier: string): { icon: string; label: string } {
  if (type === 'arrive') return { icon: '≡ƒÅü', label: 'Arrive at destination' };
  if (type === 'depart') return { icon: 'Γû╢', label: 'Depart' };
  if (type === 'rotary' || type === 'roundabout') return { icon: '≡ƒöä', label: 'Take the roundabout' };

  switch (modifier) {
    case 'uturn':          return { icon: 'Γå⌐', label: 'Make a U-turn' };
    case 'sharp right':   return { icon: 'Γå▒', label: 'Sharp right' };
    case 'right':         return { icon: 'ΓåÆ', label: 'Turn right' };
    case 'slight right':  return { icon: 'Γåù', label: 'Keep slight right' };
    case 'straight':      return { icon: 'Γåæ', label: 'Continue straight' };
    case 'slight left':   return { icon: 'Γåû', label: 'Keep slight left' };
    case 'left':          return { icon: 'ΓåÉ', label: 'Turn left' };
    case 'sharp left':    return { icon: 'Γå░', label: 'Sharp left' };
    default:              return { icon: 'Γåæ', label: 'Continue' };
  }
}
...
// ΓöÇΓöÇΓöÇ Driver Active Ride Screen ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function DriverActiveRideScreen({ ride, onClose }: { ride: any; onClose: () => void }) {
  ...
  const [routeProgress, setRouteProgress]     = useState(0); // 0ΓÇô1

  // Decoded polyline points (memoised ΓÇö only changes if ride changes)
  const polylinePoints = React.useMemo(
  ...
  // ΓöÇΓöÇ Live navigation computation ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
    if (!location || rideStatus !== 'in_progress') return;
  ...
  // ΓöÇΓöÇ Animate to pickup location when ride is first accepted ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
  ...
  // ΓöÇΓöÇ Initial camera tilt when trip starts ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
    if (rideStatus === 'in_progress' && mapRef.current) {
      setTimeout(() => {
  ...
  // ΓöÇΓöÇ Current step info ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  const currentStep = steps[navStepIndex] || null;
  const maneuver    = getManeuverIcon(
    currentStep?.maneuver?.type     || 'straight',
    currentStep?.maneuver?.modifier || 'straight'
  ...
  // ΓöÇΓöÇ Status handlers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
      ...
      if (response.data.success) {
        ...
        if (response.data.isWalletNegative) {
          Alert.alert(
            ...
            `Your wallet balance is Γé╣${response.data.walletBalance}. You cannot accept new rides until you add funds.`
          );
        }
...
{location && (
  ...
  // ΓöÇΓöÇ Completed state: show payment collection screen ΓöÇΓöÇ
...
{/* Driver position */}
        ...
        {/* Route polyline ΓÇö remaining portion highlighted */}
      ...
      {/* ΓöÇΓöÇ NAVIGATION HUD (only during active trip) ΓöÇΓöÇ */}
      {rideStatus === 'in_progress' && (
          ...
          <View style={styles.navEtaStrip}>
            ...
            <View style={styles.navEtaRow}>
              <Text style={styles.navEtaText}>
                ≡ƒòÆ {remainingETA} min
              </Text>
              <Text style={styles.navEtaText}>
                ≡ƒôì {formatDistance(remainingDist)}
              </Text>
              <Text style={styles.navEtaText}>
                Γåô {ride.drop?.address?.split(',')[0] || 'Destination'}
              </Text>
            </View>
          </View>
        </View>
      ...
      {/* ΓöÇΓöÇ Heading to pickup top bar ΓöÇΓöÇ */}
      {rideStatus === 'accepted' && (
      ...
      {/* ΓöÇΓöÇ Pre-trip info header (arrived only) ΓöÇΓöÇ */}
      {rideStatus === 'arrived' && (
        <View style={styles.navPreTripHeader}>
          ...
          <View style={styles.navPreTripMeta}>
            <Text style={styles.navPreTripMetaText}>≡ƒôÅ {ride.route?.distance || 'ΓÇö'} km</Text>
            <Text style={styles.navPreTripMetaText}>ΓÅ▒ {ride.route?.duration ? `${Math.ceil(ride.route.duration)} min` : 'ΓÇö'}</Text>
            <Text style={[styles.navPreTripMetaText, { color: colors.success }]}>Γé╣ {ride.fare?.driverShare || Math.round(ride.fare?.totalFare * 0.8) || 'ΓÇö'}</Text>
          </View>
        </View>
      )}

      {/* ΓöÇΓöÇ Bottom action sheet ΓöÇΓöÇ */}
      {rideStatus === 'accepted' ? (
        <View style={{
          position: 'absolute',
          bottom: 0,
          ...
          {rideStatus === 'arrived' && (
            <View style={{ gap: 14 }}>
              <View style={styles.premiumInputWrapper}>
                <Text style={styles.premiumInputIcon}>≡ƒöæ</Text>
                <TextInput
...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  // ΓöÇΓöÇ Light Theme Incoming Request (Figma) ΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Navigation HUD Styles ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  /** Glassmorphism card ΓÇö turn arrow + instruction text */
  navHudCard: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  /** Large turn-direction icon (Γåæ ΓåÆ ΓåÉ etc.) */
  navArrowIcon: {
    fontSize: 36,
    color: colors.bgSecondary,
    fontWeight: '700',
  ...
  /** "In 320 m" ΓÇö main distance to the next turn */
  navDistText: {
    fontSize: 24,
    fontWeight: '800',
    color: colors.bgSecondary,
  ...
  /** Street name ΓÇö "onto Anna Salai" */
  navStreetText: {
    fontSize: 12,
  ...
  /** Bottom action row during in_progress ΓÇö compact layout */
  navBottomRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  // ΓöÇΓöÇΓöÇ Customer Navigation HUD Styles ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  /** Turn instruction card ΓÇö cyan/teal theme for the customer */
  custNavHudCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: colors.accentCyan,        // #00C896 ΓÇö Mint green
    borderRadius: 20,
    paddingVertical: 14,
    paddingHorizontal: 16,
    shadowColor: colors.textPrimary,
  ...
  /** ETA strip ΓÇö white card with cyan progress bar */
  custNavEtaStrip: {
    backgroundColor: 'rgba(255,255,255,0.96)',
    borderRadius: 14,
    paddingHorizontal: 14,
  ...
  /** Customer live position pin ΓÇö teal themed */
  custNavPin: {
    width: 26,
    height: 26,
    borderRadius: 13,
  ...
  /** Compact bottom sheet during in_progress ΓÇö less height */
  custNavBottomSheet: {
    position: 'absolute',
    bottom: 0,
    left: 0,
  ...
  // ΓöÇΓöÇΓöÇ Location Picker Styles ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  pickerHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  // ΓöÇΓöÇΓöÇ New Home Screen Styles ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Customer Home ΓÇô Map Header ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custMapHeader: {
    position: 'absolute',
    top: Platform.OS === 'ios' ? 54 : 36,
    left: 16,
  ...
  // ΓöÇΓöÇΓöÇ Search bar update ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  homeSearchIconWrap: {
    width: 32,
    height: 32,
    borderRadius: 10,
  ...
  // ΓöÇΓöÇΓöÇ Estimate cards update ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  estTypeActive: {
    color: colors.accent,
    fontWeight: '800',
  },
  ...
  // ΓöÇΓöÇΓöÇ Customer Tab Pages ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custTabPage: {
    flex: 1,
    backgroundColor: colors.bgPrimary,
  ...
  // ΓöÇΓöÇΓöÇ Profile Card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custProfileCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: colors.bgSecondary,
  ...
  // ΓöÇΓöÇΓöÇ Wallet Card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custWalletCard: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  // ΓöÇΓöÇΓöÇ Menu Card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custMenuCard: {
    backgroundColor: colors.bgSecondary,
    marginHorizontal: 20,
    borderRadius: 20,
  ...
  // ΓöÇΓöÇΓöÇ Edit Profile Card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custEditCard: {
    backgroundColor: colors.bgSecondary,
    marginHorizontal: 20,
    borderRadius: 20,
  ...
  // ΓöÇΓöÇΓöÇ Logout Button ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custLogoutBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  // ΓöÇΓöÇΓöÇ Trips / Ride Card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custRideCard: {
    backgroundColor: colors.bgSecondary,
    marginHorizontal: 20,
    marginBottom: 14,
  ...
  // ΓöÇΓöÇΓöÇ Services Grid ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  custServiceCard: {
    width: '47%',
    backgroundColor: colors.bgSecondary,
    borderRadius: 18,
